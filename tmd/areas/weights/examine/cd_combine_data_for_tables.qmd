...
write_csv(compare, here::here("intermediate", "compare.csv"))
  

compare |> filter(statecd=="ak00")
compare |> filter(statecd=="ny21")
compare |> filter(statecd=="tx27")
compare |> filter(statecd=="wa04")
