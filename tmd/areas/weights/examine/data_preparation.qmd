...
Supplement the weights with selected TMD variables and summarize. Update when area weights change, or the national TMD data change, or if we choose to summarize additional TMD variables.
