...
tmdplusweights <- tmd2021 |> 
  ...
  relocate(row, wtdn, agistub, .after = RECID) |> 
...
# ~ 8gb used in creating wtditems, but it cannot be very large
wtditems <- long1 |> 
...
write_csv(sums_plus_agistubtot, here::here("intermediate", "wtditems_enhanced.csv"))
