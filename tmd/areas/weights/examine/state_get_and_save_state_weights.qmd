...
f <- function(fpath){
  ...
  vroom(fpath, col_select = "WT2021") |>
    rename(!!area := WT2021) # create a column named for the cd, with its 2021 as its value
}
...
system.time(saveRDS(weights, here::here("intermediate", paste0(areatype, "_weights.rds")))) # 23 seconds
