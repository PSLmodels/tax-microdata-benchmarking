...
write_csv(cdpop5year, fs::path(CDINTERMEDIATE, "cdpop5year_acs.csv"))
...
write_csv(cdpop1year, fs::path(CDINTERMEDIATE, "cdpop1year_acs.csv"))
...
cdpop1year <- read_csv(fs::path(CDINTERMEDIATE, "cdpop1year_acs.csv"))
cdpop5year <- read_csv(fs::path(CDINTERMEDIATE, "cdpop5year_acs.csv"))
