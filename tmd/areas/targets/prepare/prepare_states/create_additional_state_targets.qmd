...
base_targets <- readr::read_csv(fs::path(DINTERMEDIATE, "base_targets.csv"))
...
soivname_targets <- soivname_shares |> 
  ...
  select(stabbr, area, count, scope, agilo, agihi, fstatus, target, basesoivname, soivname, description, agistub, agilabel, tmdvar)
